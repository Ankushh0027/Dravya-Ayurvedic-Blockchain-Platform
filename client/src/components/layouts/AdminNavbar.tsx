      ...
      <nav className="flex items-center justify-between px-4 sm:px-6 py-2.5 max-w-[1600px] mx-auto w-full">
        ...
        <div className="hidden lg:flex items-center gap-1 mx-4">
          <Link href="/admin/dashboard">
            <Button variant="ghost" className={`text-sm font-semibold rounded-xl px-4 transition-all duration-300 ${isActive('/admin/dashboard') ? 'bg-white/10 text-white shadow-inner' : 'text-slate-300 hover:text-white hover:bg-white/5'}`}>
