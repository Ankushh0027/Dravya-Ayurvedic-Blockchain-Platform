    ...
    <div className="w-full bg-[#184E48] backdrop-blur-xl border-b border-white/10 shadow-[0_4px_20px_rgb(0,0,0,0.1)] transition-all duration-300 sticky top-0 z-50">
      <nav className="flex items-center justify-between px-4 sm:px-6 py-2.5 max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          <Link href="/lab/dashboard" className="flex items-center gap-3 group">
        ...
        <div className="hidden lg:flex items-center gap-1 mx-4">
          <Link href="/lab/dashboard">
            <Button variant="ghost" className={`text-sm font-semibold rounded-xl px-4 transition-all duration-300 ${isActive('/lab/dashboard') ? 'bg-white/10 text-white shadow-inner' : 'text-slate-300 hover:text-white hover:bg-white/5'}`}>
              <LayoutDashboard className="w-4 h-4 mr-2" />
              Dashboard
            </Button>
          </Link>
          <Link href="/lab/tests">
            <Button variant="ghost" className={`text-sm font-semibold rounded-xl px-4 transition-all duration-300 ${isActive('/lab/tests') ? 'bg-white/10 text-white shadow-inner' : 'text-slate-300 hover:text-white hover:bg-white/5'}`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex flex-col items-end mr-2">
              ...
              <span className="text-[10px] text-teal-200 font-medium uppercase tracking-wider">Lab User</span>
            </div>
