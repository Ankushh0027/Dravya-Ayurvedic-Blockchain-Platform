              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={physicalQualityStatus} onValueChange={(val) => setPhysicalQualityStatus(val || '')} disabled={isFinalized}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={packagingStatus} onValueChange={(val) => setPackagingStatus(val || '')} disabled={isFinalized}>
                      <SelectTrigger className="bg-white">
