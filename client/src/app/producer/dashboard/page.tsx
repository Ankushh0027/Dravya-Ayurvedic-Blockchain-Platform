...
export default function ProducerDashboard() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-6 md:p-10 space-y-10">
      ...
      {hasNoActivity && (
        <Card className={`${glassCard} border-[#184E48]/20 bg-gradient-to-br from-white/90 to-[#184E48]/5`}>
              ...
              <div className="space-y-3">
                ...
                <div className="pt-4">
                  <Link href="/producer/batches" className="w-full inline-block">
                    <Button variant="outline" className="w-full bg-slate-50 hover:bg-slate-100 text-[#1e293b] border-slate-200 rounded-xl font-bold py-6">
                      View All Batches
                    </Button>
                  </Link>
                </div>
