...
export function TeamCarousel() {
  ...
  const team = [
    { name: 'Anubhav Dwivedi', role: t('about.team.anubhavRole'), bio: t('about.team.anubhavBio'), image: '/assets/team/Anubhav.png', position: 'object-top' },
    { name: 'Ankush Gangwar', role: t('about.team.ankushRole'), bio: t('about.team.ankushBio'), image: '/assets/team/Ankush.jpeg', position: 'object-center' },
    { name: 'Anshuman Sabat', role: t('about.team.anshumanRole'), bio: t('about.team.anshumanBio'), image: '/assets/team/Anshuman.jpeg', position: 'object-top' },
    { name: 'Gopal Shrivastav', role: t('about.team.gopalRole'), bio: t('about.team.gopalBio'), image: '/assets/team/Gopal.jpeg', position: 'object-center' },
    { name: 'Aradhya Singh', role: t('about.team.aradhyaRole'), bio: t('about.team.aradhyaBio'), image: '/assets/team/Aradhya.jpeg', position: 'object-top' },
    { name: 'Shubhi Tiwari', role: t('about.team.shubhiRole'), bio: t('about.team.shubhiBio'), image: '/assets/team/Shubhi.jpeg', position: 'object-center' },
  ]
