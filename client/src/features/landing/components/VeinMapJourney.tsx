                  ...
                  {flowSteps.map((step, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div
                            className={`px-2.5 py-1 rounded-lg text-xs font-bold border transition-all duration-200 w-fit whitespace-nowrap ${isActive
                    ...
                    {flowSteps.map((s) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3.5 py-2 rounded-xl text-xs md:text-sm font-bold transition-all duration-150 border cursor-pointer ${active
