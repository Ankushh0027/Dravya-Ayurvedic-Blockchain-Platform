        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-slate-700 font-semibold text-sm ml-1">{t('auth.fullName')} <span className="text-red-500">*</span></FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-slate-700 font-semibold text-sm ml-1">{t('auth.emailLabel')} <span className="text-red-500">*</span></FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-slate-700 font-semibold text-sm ml-1">{t('auth.passwordLabel')} <span className="text-red-500">*</span></FormLabel>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-slate-700 font-semibold text-sm ml-1">{t('auth.confirmPasswordLabel')} <span className="text-red-500">*</span></FormLabel>
                  <div className="relative">
                    <FormControl>
                      <Input
